...
interface AggImplementor {
     ...
     *
     * <blockquote>`reset.currentBlock().add(<br></br>
     * Expressions.statement(<br></br>
     * Expressions.assign(reset.accumulator().get(0),<br></br>
     * Expressions.constant(0)));`</blockquote>
     *
     * @param info Aggregate context
     ...
     */
    fun implementResult(info: AggContext?, result: AggResultContext?): Expression?
}
