 ...
 */
abstract class AggResetContextImpl protected constructor(block: BlockBuilder?, accumulator: List<Expression>) :
    NestedBlockBuilderImpl(block), AggResetContext {
    private val accumulator: List<Expression>
