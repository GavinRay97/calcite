...
enum class HepMatchOrder {
     ...
     *
     *
     * It avoids applying a rule to the previous
     * [org.apache.calcite.rel.RelNode] repeatedly after new vertex is
     * generated in one rule application. It can therefore be more efficient than
     * [.ARBITRARY] in cases such as
     * [org.apache.calcite.rel.core.Union] with large fan-out.
     */
    DEPTH_FIRST
}
