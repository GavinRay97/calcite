 ...
 */
// TODO: obsolete this?
abstract class CommonRelSubExprRule  //~ Constructors -----------------------------------------------------------
/** Creates a CommonRelSubExprRule.  */
protected constructor(config: Config?) : RelRule<CommonRelSubExprRule.Config?>(config) {
    /** Rule configuration.  */
