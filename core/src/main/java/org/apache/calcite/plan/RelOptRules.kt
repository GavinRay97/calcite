...
@Experimental
object RelOptRules {
    /** Calc rule set; public so that [org.apache.calcite.tools.Programs] can
     * use it.  */
    val CALC_RULES: ImmutableList<RelOptRule> = ImmutableList.of(
        ...
        CoreRules.CALC_MERGE,  // REVIEW jvs 9-Apr-2006: Do we still need these two?  Doesn't the
        // combination of CalcMergeRule, FilterToCalcRule, and
        // ProjectToCalcRule have the same effect?
        CoreRules.FILTER_CALC_MERGE,
        CoreRules.PROJECT_CALC_MERGE
    )
    val BASE_RULES: List<RelOptRule> = ImmutableList.of(
    ...
    val ABSTRACT_RULES: List<RelOptRule> = ImmutableList.of(
    ...
    val ABSTRACT_RELATIONAL_RULES: List<RelOptRule> = ImmutableList.of(
        CoreRules.FILTER_INTO_JOIN,
    ...
    val CONSTANT_REDUCTION_RULES: List<RelOptRule> = ImmutableList.of(
    ...
    val MATERIALIZATION_RULES: List<RelOptRule> = ImmutableList.of(
