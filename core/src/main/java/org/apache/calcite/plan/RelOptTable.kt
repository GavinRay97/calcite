...
/**
 * Represents a relational dataset in a [RelOptSchema]. It has methods to
 * describe and implement itself.
 */
interface RelOptTable : Wrapper {
    //~ Methods ----------------------------------------------------------------
    /**
    ...
    /**
     * Converts this table into a [relational expression][RelNode].
     *
     *
     * The [planner][org.apache.calcite.plan.RelOptPlanner] calls this
     ...
     * applying [rules][org.apache.calcite.plan.RelOptRule] to transform it
     ...
     *
     * @see RelMetadataQuery.collations
     */
    @get:Nullable
     ...
     * in this table.
     *
     * @see RelMetadataQuery.distribution
     */
    @get:Nullable
     ...
     * the result should be consistent with `isKey`.
     */
    @get:Nullable
    val keys: List<Any?>?
     ...
     *
     *
     * The extended table includes the fields of this base table plus the
     ...
     * expression.  */
    interface ToRelContext : ViewExpander {
