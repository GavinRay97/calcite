...
enum class Lex(
    ...
    vararg charLiteralStyles: CharLiteralStyle
) {
    ...
    BIG_QUERY(
        Quoting.BACK_TICK_BACKSLASH, Casing.UNCHANGED, Casing.UNCHANGED,
    ...
    MYSQL(
        Quoting.BACK_TICK, Casing.UNCHANGED, Casing.UNCHANGED, false,
        CharLiteralStyle.STANDARD
    ),
    ...
    MYSQL_ANSI(
        Quoting.DOUBLE_QUOTE, Casing.UNCHANGED, Casing.UNCHANGED, false,
        CharLiteralStyle.STANDARD
    ),
    ...
    SQL_SERVER(
        Quoting.BRACKET, Casing.UNCHANGED, Casing.UNCHANGED, false,
        CharLiteralStyle.STANDARD
    ),
    ...
    JAVA(
        Quoting.BACK_TICK, Casing.UNCHANGED, Casing.UNCHANGED, true,
        CharLiteralStyle.STANDARD
    );

    val quoting: Quoting
    val unquotedCasing: Casing
    val quotedCasing: Casing
    val caseSensitive: Boolean

    @SuppressWarnings("ImmutableEnumChecker")
    val charLiteralStyles: Set<CharLiteralStyle>
