 ...
 */
class CalciteException @SuppressWarnings(["argument.type.incompatible", "method.invocation.invalid"]) constructor(
    message: String?,
    cause: Throwable?
    ...
    companion object {
         ...
         */
        private const val serialVersionUID = -1314522633397794178L
        private val LOGGER: Logger = LoggerFactory.getLogger(CalciteException::class.java)
    }
}
