...
object BinarySearch {
     ...
     * the given key or the array is empty. Returns `a.length` when all
     * elements are less than the given key.
    </T> */
    fun <T> lowerBound(a: Array<T>, key: T, comparator: Comparator<T>): Int {
        return lowerBound(
            a, key, 0, a.size - 1,
     ...
     * than the given key or the array is empty. Returns `a.length` when
     * all elements exceed the given key.
    </T> */
    fun <T> upperBound(a: Array<T>, key: T, comparator: Comparator<T>): Int {
        return upperBound(
            a, key, 0, a.size - 1,
            Functions.identitySelector(), comparator
        )
    ...
    fun <T, K> lowerBound(
        a: Array<T>, key: K, keySelector: Function1<T, K>,
        comparator: Comparator<K>
    ): Int {
        return lowerBound(a, key, 0, a.size - 1, keySelector, comparator)
    }
    ...
    fun <T, K> upperBound(
        ...
        return upperBound(a, key, 0, a.size - 1, keySelector, comparator)
    }
    ...
    fun <T> lowerBound(
        a: Array<T>, key: T, imin: Int, imax: Int,
     ...
     */
    fun <T, K> lowerBound(
        a: Array<T>, key: K, imin: Int, imax: Int,
        keySelector: Function1<T, K>, comparator: Comparator<K>
    ): Int {
        ...
        val cmp: Int = comparator.compare(keySelector.apply(a[imin]), key)
        if (cmp == 0) {
