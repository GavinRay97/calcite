...
/** Mutable equivalent of [org.apache.calcite.rel.core.Minus].  */
class MutableMinus private constructor(
    cluster: RelOptCluster, rowType: RelDataType,
    inputs: List<MutableRel>, all: Boolean
) : MutableSetOp(cluster, rowType, MutableRelType.MINUS, inputs, all) {
    @Override
    ...
    companion object {
        ...
        fun of(
            ...
            return MutableMinus(input0.cluster, rowType, inputs, all)
        }
    }
}
