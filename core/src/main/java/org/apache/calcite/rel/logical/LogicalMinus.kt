...
/**
 * Sub-class of [org.apache.calcite.rel.core.Minus]
...
class LogicalMinus : Minus {
    ...
    fun copy(
        ...
        return LogicalMinus(getCluster(), traitSet, inputs, all)
    }
