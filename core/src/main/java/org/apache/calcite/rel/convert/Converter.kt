 ...
 * [trait][org.apache.calcite.plan.RelTrait], of a relational expression
...
interface Converter : RelNode {
     ...
     * this trait and have the value given by [.getInputTraits], and the
     * traits of the output of this converter given by [.getTraitSet] will
