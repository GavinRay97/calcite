 ...
 *
 *
 * A match rule is defined though [org.apache.calcite.rel.hint.HintPredicate].
 * [org.apache.calcite.rel.hint.NodeTypeHintPredicate] matches a relational expression
 ...
 *
 *
 *  * Right after a `SqlNode` tree is converted to `RelNode` tree, we would
 ...
 * RelOptUtil#RelHintPropagateShuttle for how it works.
 *  * During rule planning, in the transforming phrase of a `RelOptRule`,
 ...
 *
 * <h2>Design Doc</h2>
 * [Calcite SQL and Planner Hints Design](https://docs.google.com/document/d/1mykz-w2t1Yw7CH6NjUWpWqCAf_6YNKxSc59gXafrNCs/edit?usp=sharing).
 */
