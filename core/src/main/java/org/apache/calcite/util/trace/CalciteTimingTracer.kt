...
class CalciteTimingTracer(
     ...
     */
    fun traceTime(event: String?) {
        if (logger == null) {
            return
        }
        val newNanoTime: Long = System.nanoTime()
        val elapsed = newNanoTime - lastNanoTime
    ...
    companion object {
        ...
        private val DECIMAL_FORMAT: DecimalFormat = NumberUtil.decimalFormat("###,###,###,###,###")
    }
}
