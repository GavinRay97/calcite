 ...
 * @see CollectScope
 */
class CollectNamespace internal constructor(
    child: SqlCall,
    scope: SqlValidatorScope,
    enclosingNode: SqlNode?
) : AbstractNamespace(scope.getValidator() as SqlValidatorImpl, enclosingNode) {
    //~ Instance fields --------------------------------------------------------
    private val child: SqlCall
    ...
    init {
        ...
        this.scope = scope
        assert(
            child.getKind() === SqlKind.MULTISET_VALUE_CONSTRUCTOR
