 ...
 *
 *
 * Based on Oracle's `TRANSLATE` function, it is commonly called
 * "TRANSLATE3" to distinguish it from the standard SQL function
 * [SqlStdOperatorTable.TRANSLATE] that takes 2 arguments and has an
 * entirely different purpose.
 */
class SqlTranslate3Function  //~ Constructors -----------------------------------------------------------
/**
...
internal constructor() : SqlFunction(
    ...
    fun unparse(
        ...
        val frame: SqlWriter.Frame = writer.startFunCall("TRANSLATE")
        for (sqlNode in call.getOperandList()) {
            writer.sep(",")
