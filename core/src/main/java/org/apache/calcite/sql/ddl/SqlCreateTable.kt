...
class SqlCreateTable(
    ...
    name: SqlIdentifier?, @Nullable columnList: SqlNodeList?, @Nullable query: SqlNode?
) : SqlCreate(
    ...
    companion object {
        private val OPERATOR: SqlOperator = SqlSpecialOperator("CREATE TABLE", SqlKind.CREATE_TABLE)
    }
}
