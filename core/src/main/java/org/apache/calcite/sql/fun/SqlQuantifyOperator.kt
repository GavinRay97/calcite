 ...
 */
class SqlQuantifyOperator internal constructor(kind: SqlKind, comparisonKind: SqlKind) :
    SqlInOperator(comparisonKind.sql + " " + kind, kind) {
    //~ Instance fields --------------------------------------------------------
