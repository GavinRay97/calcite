...
interface ImplicitCastOperandTypeChecker {
     ...
     */
    fun checkOperandTypesWithoutTypeCoercion(callBinding: SqlCallBinding?, throwOnFailure: Boolean): Boolean
     ...
     */
    fun getOperandSqlTypeFamily(iFormalOperand: Int): SqlTypeFamily?
}
