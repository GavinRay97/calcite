...
/**
 * The `GROUPING` function. It accepts 1 or more arguments and they must be
 ...
 */
internal class SqlGroupingFunction(name: String?) : SqlAbstractGroupFunction(
    name, SqlKind.GROUPING, ReturnTypes.BIGINT, null,
