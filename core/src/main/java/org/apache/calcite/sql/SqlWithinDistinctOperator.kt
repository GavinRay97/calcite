 ...
 *
 */
class SqlWithinDistinctOperator : SqlBinaryOperator(
    "WITHIN DISTINCT", SqlKind.WITHIN_DISTINCT, 100, true,
    ...
    fun unparse(
        ...
        val orderFrame: SqlWriter.Frame = writer.startList(SqlWriter.FrameTypeEnum.GROUP_BY_LIST, "(", ")")
    ...
    fun validateCall(
        ...
        for (order in Objects.requireNonNull(flat.distinctList)) {
