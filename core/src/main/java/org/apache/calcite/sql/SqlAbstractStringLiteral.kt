 ...
 */
abstract class SqlAbstractStringLiteral  //~ Constructors -----------------------------------------------------------
protected constructor(
    value: Object?,
    typeName: SqlTypeName?,
    pos: SqlParserPos?
) : SqlLiteral(value, typeName, pos) {
    //~ Methods ----------------------------------------------------------------
    /**
     * Helper routine for [SqlUtil.concatenateLiterals].
     *
     * @param literals homogeneous StringLiteral args
     * @return StringLiteral with concatenated value. this == lits[0], used only
     * for method dispatch.
     */
    protected abstract fun concat1(
