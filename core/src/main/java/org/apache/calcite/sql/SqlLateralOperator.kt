 ...
 */
class SqlLateralOperator  //~ Constructors -----------------------------------------------------------
    (kind: SqlKind) : SqlSpecialOperator(
    kind.name(), kind, 200, true, ReturnTypes.ARG0, null,
    OperandTypes.ANY
) {
    //~ Methods ----------------------------------------------------------------
    @Override
    fun unparse(
        ...
        val specialOperandKinds: Set<SqlKind> = ImmutableSet.of(
