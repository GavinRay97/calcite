...
/**
 * Extension to [Table] that specifies how it is to be translated to
 * a [relational expression][org.apache.calcite.rel.RelNode].
 *
 *
 ...
 */
interface TranslatableTable : Table {
