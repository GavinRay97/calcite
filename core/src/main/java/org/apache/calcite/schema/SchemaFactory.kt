 ...
 * [example CSV adapter](https://calcite.apache.org/javadocAggregate/org/apache/calcite/adapter/csv/package-summary.html)
 ...
 *
 *
 * If you do not wish to allow model authors to add additional tables
 * (including views) to an instance of your schema, specify
 * 'mutable: false'.
 *
 *
 * A class that implements SchemaFactory specified in a schema must have a
